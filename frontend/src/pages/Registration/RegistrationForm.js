    ...
    return (
        <div className="cards cards-space">
            ...
            <div className="card-footer">
                <div>
                    <a className="btn btn-primary btn-lg form-signin-button" href='/reg-company-firstpage'>Company</a>
                </div>
            </div>
        </div>
    );
...
const RegistrationCardR = (props) => {
    return (
        <div className="cards cards-space">
            ...
            <div className="card-footer">
                <div>
                    <a className="btn btn-primary btn-lg form-signin-button" href='/reg-researcher-firstpage'>Researcher</a>
                </div>
            </div>
        </div>
    );
